...
warehouseInventoryRouter.patch('/warehouse-inventory/:id', warehouseInventoryController.updateWarehouseInventory);
warehouseInventoryRouter.delete('/warehouse-inventory/:id', warehouseInventoryController.deleteWarehouseInventory);
warehouseInventoryRouter.delete('/warehouse-inventory', warehouseInventoryController.deleteWarehouseInventory);
